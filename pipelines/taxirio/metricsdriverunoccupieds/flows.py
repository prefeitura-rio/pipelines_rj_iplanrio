...
with Flow(
    ...
    parallelism=1,
) as rj_iplanrio__taxirio__metricsdriverunoccupieds__flow:
...
rj_iplanrio__taxirio__metricsdriverunoccupieds__flow.storage = GCS(Constants.GCS_FLOWS_BUCKET.value)

rj_iplanrio__taxirio__metricsdriverunoccupieds__flow.schedule = every_day(2024, 10, 10, 1, 0)

rj_iplanrio__taxirio__metricsdriverunoccupieds__flow.run_config = KubernetesRun(
