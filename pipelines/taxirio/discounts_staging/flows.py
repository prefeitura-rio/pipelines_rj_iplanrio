...
rj_iplanrio__taxirio__discounts__staging__flow = deepcopy(rj_iplanrio__taxirio__discounts__flow)

rj_iplanrio__taxirio__discounts__staging__flow.name = (
    "IPLANRIO: discounts - Dump da tabela do MongoDB do TaxiRio (homologação)"
)
